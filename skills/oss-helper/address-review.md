...
If you have access to agents specialized in **coding or implementation** (e.g., backend, frontend, or language-specific coding agents), you should delegate the code changes in steps 6–7 to one or more of those agents. Provide them with the review comments, affected files, and project standards context. If no specialized agents are available, perform all steps directly.
...
### 3. Understand Context via Git History
...
### 9. Final Sanity Build (MANDATORY before commit)
