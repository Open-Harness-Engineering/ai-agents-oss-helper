...
The next OSS Helper command run from any project that matches one of these remote patterns will load the matching rules through OSS Helper initialization (step 2B) without any further configuration.
...
- Subsequent OSS Helper commands load the newly installed rules through OSS Helper initialization (step 2B)
