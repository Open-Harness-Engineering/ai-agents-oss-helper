...
> Template project `<project>` not found. Run the Install Info guideline (`install-info.md`) to see available projects.
...
| Scope-too-large redirect | From template or Create Issue guideline (`create-issue.md`) |
...
- Scope-too-large redirect: Create Issue guideline (`create-issue.md`)
...
- Modify `install.sh` or `README.md`
...
- Generated rules are loadable by the OSS Helper initialization without errors
