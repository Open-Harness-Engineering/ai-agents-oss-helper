...
If no workspace exists, stop and tell the user to run the Workspace Init guideline (`oss-workspace-init.md`) first.
...
### 3. Fetch and Analyze the Canonical Issue
...
### 5. Produce Cross-Repo Impact Plan
...
### 6. Prepare Branches and Worktrees
